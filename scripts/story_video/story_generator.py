...
DEFAULT_SYSTEM_PROMPT = """你是一位专业的短视频文案编剧，擅长将历史人物和事件改编成引人入胜的抖音短视频故事。
...
def generate_story(
    ...
    usr_template = user_prompt_template or DEFAULT_USER_TEMPLATE
    user_prompt = usr_template.format(topic=topic, num_scenes=num_scenes)
