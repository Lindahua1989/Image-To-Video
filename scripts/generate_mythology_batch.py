...
def generate_one(name: str, brief: str, api_key: str = "") -> bool:
    ...
    Requires story.json to be pre-generated by the AI assistant.
    """
    work_dir = OUTPUT_DIR / f"story_{name}"
    story_path = work_dir / "story.json"

    if not story_path.exists():
        print(f"\n[SKIP] {name}: story.json not found at {story_path}")
        print(f"       The AI assistant must generate story.json first.")
        return False
